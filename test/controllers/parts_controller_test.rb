...
class PartsControllerTest < ActionController::TestCase
  ...
  test "should create part" do
    assert_difference('Part.count') do
      post :create, part: { cnt: @part.cnt, own_id: @part.own_id, third_id: @part.third_id, user_id: @part.user_id }
    end
  ...
  test "should update part" do
    patch :update, id: @part, part: { cnt: @part.cnt, own_id: @part.own_id, third_id: @part.third_id, user_id: @part.user_id }
    assert_redirected_to part_path(assigns(:part))
  end
